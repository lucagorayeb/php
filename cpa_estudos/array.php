...
// in_array() - Serve para informar se em certo array tem certo elemento.
...
// array_merge() - Serve para unir dois arrays.

$outrasFrutas = ['Abacaxi', 'Limão'];

echo '<pre>';
var_dump($outrasFrutas);
echo '</pre>';

echo '<br> <br>';

$todasFrutas = array_merge($outrasFrutas, $frutas);
